 ...
 */
export function handleImg(username, id) {
  // return validatenull(url) ? null : service({
  //   url:  url,
  //   method: 'get',
  //   responseType: 'blob'
  ...
  //   }, 0)
  // })
  return validatenull(username) ? null : service({
    url:  `${baseUrl}admin/sys-file/avatar/${username}`,
    method: 'get',
    responseType: 'blob'
  }).then((response) => {
    const img = document.getElementById(id)
