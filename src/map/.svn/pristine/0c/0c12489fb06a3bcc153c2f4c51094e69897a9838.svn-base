...
import DxImageCanvasLayer from "./layer/imageCanvasLayer";
import DxStaticImageLayer from "./layer/staticImageLayer";
...
export async function getImageLayer({ type, url, ...options }) {
  ...
  switch (type) {
    ...
    case "hgt":
      ...
      break;
    case "imagecanvas":
      layer = new DxImageCanvasLayer(options);
      break;
    case "image":
      layer = new DxStaticImageLayer(options);
      break;
    default:
      break;
  }
