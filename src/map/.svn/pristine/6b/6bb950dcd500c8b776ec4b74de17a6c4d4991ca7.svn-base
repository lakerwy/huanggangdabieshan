const route = [
  {
    ...
    children: [
      ...
      },
      {
        path: "staticMap",
        name: "t_staticMap",
        component: () => import("./components/map.staticMap.test.vue")
      },
      {
        path: "map_url_arcgis",
      ...
      {
        path: "map_url_image",
        name: "t_map_url_image",
        component: () => import("./components/map.url.image.test.vue")
      },
      {
      ...
      },
      {
        path: "map_json_gif",
        name: "t_json_gif",
        component: () => import("./components/map.json.gif.test.vue")
      },
      {
