  ...
  <div class="add-remain">
    <div class="page-content">
      <steps ref="steps" class="step-content" @getCurrentStep="getCurrentStep">
        <div class="form" v-show="currentStep == 0">
          <div class="scrollbar">
            <el-form
              :model="form"
              :rules="rules"
        ...
        <div class="form-normal" v-show="currentStep == 1">
        ...
        <div class="uploaded" v-show="currentStep == 1">
        ...
        <div class="btn-con" v-show="currentStep == 1">
          <el-button
            class="next-btn"
            style="float: left"
            plain
            ...
            >返回</el-button
          >
          <el-button style="" class="next-btn" plain type="" @click="back"
            >上一步</el-button
          >
          <el-button
