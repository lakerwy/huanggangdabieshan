  ...
  <div class="files-management">
    <div class="page-content">
      <div class="left">
        ...
        <div
          class="scrollbar"
          style="width: 100%; overflow: auto; height: calc(100% - 112px)"
        >
          <el-tree
            ref="tree"
            class="my-tree"
          ...
          >
            <template #default="{ node, data }">
              <span
                ...
                :class="{ circle: node.level > 1 && node.isLeaf }"
                @mouseenter="data.isShowDel = true"
                @mouseleave="data.isShowDel = false"
              >
                <div
                  v-show="node.isLeaf"
                  style="
                ...
                >
                <img
                  v-show="data.isShowDel && files_management_del"
                  style="
                    float: right;
                    margin-right: 5px;
                    vertical-align: middle;
                  "
                  src="imgs/icon_trash.png"
                  alt=""
                  @click.stop="deleteBanch('tree', data)"
                />
              </span>
            </template>
          </el-tree>
        ...
        <div class="top-operation">
          <div class="btns">
            <el-dropdown @command="handleCommand">
              <el-button plain class="upload-btn" title="上传"
                ><img
                  style="vertical-align: sub; margin-right: 6px"
                  src="imgs/icon_upload.png"
                  alt=""
                />上传</el-button
              >
              <template #dropdown>
            ...
            <el-button
              ...
              @click="downloadBanch"
              title="下载"
              ><img src="imgs/icon_download.png" alt=""
            /></el-button>
            <el-button plain 
            v-if="files_management_addFile" title="新建文件夹" @click="newFolder"
              ><img src="imgs/icon_new.png" alt=""
            /></el-button>
            <el-button plain title="删除" 
            v-if="files_management_del" @click="deleteBanch"
...
import uploadModule from './index/upload.js'
import tableModule from './index/table.js'
import treeModule from './index/tree.js'
import moveMoudle from './index/move.js'
...
export default {
  ...
  data() {
    return {
      files_management_addFile: false,
  ...
  created() {
    this.files_management_addFile = this.permissions['files_management_addFile']
  ...
  setup() {
    ...
    const {
      ...
      cancelMove,
      doMove
    } = moveMoudle(vm, treeData,handleNodeClick);
