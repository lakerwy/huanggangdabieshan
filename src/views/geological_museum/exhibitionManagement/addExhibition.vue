  ...
  <div>
    ...
    >
      <el-form ref="form" :model="form" label-width="80px" :rules="rules">
        ...
        <el-form-item label="展厅排序" prop="order">
          <el-input-number
            v-model="form.order"
            :min="1"
            :max="10000"
        ...
        <el-form-item label="展厅详情" prop="info">
          <el-input type="textarea" v-model="form.info"></el-input>
        </el-form-item>
        <el-form-item label="展厅照片">
          <el-upload
            class="upload-demo"
            action="#"
            ref="upload"
...
export default {
  ...
  methods: {
    close() {
      this.$parent.showExhibition = false;
    },
    ...
    confirm() {
      ...
      that.$refs['form'].validate((valid) => {
        if (valid) {
          ...
          axios({
            url: window.globalUrl.HOME_API + '/datamanager/show-room/addShow',
            method: 'POST', //请求方式
            ...
            if (res.success == true) {
              this.$message({
                showClose: true,
                message: `新增展厅:${this.form.name}成功！`,
                type: 'success'
              });
              that.$parent.showExhibition = false;
