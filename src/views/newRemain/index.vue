    ...
    <div class="page-content">
      <steps ref="steps" class="step-content" @getCurrentStep="getCurrentStep">
        <template v-if="currentStep == 0">
          <div class="form">
            <div class="scrollbar">
              <el-form :model="form" :rules="rules" ref="ruleForm" label-width="140px" label-position="left">
                <div class="item-con">
                  <el-row>
                    <el-col :span="10">
                      <el-form-item label="遗迹编号" prop="number" class="mandatory">
                        <el-input v-model="form.number"></el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="14" class="col_center">
                      <el-form-item label="名称" prop="name" label-width="109px" class="mandatoryCon">
                ...
                <div class="item-con">
                  <el-row>
                    <el-col :span="7">
                      <el-form-item label="东经" prop="longitude" class="mandatory">
                        <el-input v-model="form.longitude"></el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="6" class="col_center">
                      <el-form-item label="北纬" prop="latitude"  label-width="110px" class="mandatoryCon">
                        <el-input v-model="form.latitude"></el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="5">
                      <el-form-item label="海拔" prop="elevation" label-width="80px" class="mandatoryCon">
                        <el-input v-model="form.elevation"></el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="6">
                      <el-form-item label="面积" prop="proportion" label-width="80px" class="mandatoryCon">
                        <el-input v-model="form.proportion"></el-input>
                      </el-form-item>
                    </el-col>
                  </el-row>
                </div>
                <el-form-item label="行政区属" prop="administrativeDistrict" class="mandatory">
                  <el-input v-model="form.administrativeDistrict"></el-input>
                </el-form-item>
                <el-form-item label="地理位置" prop="position" class="mandatory">
                  <el-input v-model="form.position"></el-input>
                </el-form-item>
                <el-form-item label="交通状况" prop="trafficCondition" class="mandatory">
                  <el-input v-model="form.trafficCondition"></el-input>
                </el-form-item>
                <el-form-item label="遗迹景观类型" prop="landscapeTypes" class="mandatory">
                  <el-select v-model="form.landscapeTypes" placeholder="请选择遗迹景观类型">
                    <el-option
                ...
                <el-form-item label="地质遗迹景观描述与特征参数" prop="description" class="mandatory">
                  <el-input type="textarea" rows="4" v-model="form.description"></el-input>
                </el-form-item>
                <el-form-item label="成因分析" prop="cause" class="mandatory">
                  <el-input type="textarea" v-model="form.cause"></el-input>
                </el-form-item>
                <el-form-item label="其它景观" prop="otherLandscape" class="mandatory">
                  <el-input v-model="form.otherLandscape"></el-input>
                </el-form-item>
                <el-form-item label="环境与保护现状" prop="currentSituation" class="mandatory">
                  <el-input type="textarea" v-model="form.currentSituation"></el-input>
                </el-form-item>
                <el-form-item label="开发现状" prop="developmentSituation" class="mandatory">
                  <el-input v-model="form.developmentSituation"></el-input>
                </el-form-item>
                <el-form-item label="保护措施" prop="protection" class="mandatory">
                  <el-input v-model="form.protection"></el-input>
                </el-form-item>
                <el-form-item label="级别" prop="level" class="mandatory">
                ...
                <el-form-item label="是否重要" prop="isImportant" class="mandatory">
                  <el-select v-model="form.isImportant" placeholder="请选择是否重要">
                    <el-option
            ...
            <el-button class="next-btn" style="float: right;" plain type="" @click="next">下一步</el-button>
          </div>
        </template>
        <template v-if="currentStep == 1">
          <div class="form-normal">
            <el-form :model="form" label-width="143px" label-position="left">
              <el-form-item label="添加附件：">
                ...
                >
                  <img style="margin-top: 18%;" src="imgs/icon-file.png" alt="">
                  <div class="el-upload__text">将图片拖到此处或<em>点击上传</em></div>
                  <div class="el-upload__text">图片大小不超过5M,格式为JPG、PNG、JPEG</div>
                </el-upload>
              </el-form-item>
            </el-form>
          </div>
            ...
            <div class="img-list">
              <div class="con">
                <div class="list" v-for="item in imgs" :key="item.id">
                  ...
                  <div class="img_del">
                    <img src="imgs/del_white.png" @click="delImgUpload(item.id)" alt="">
                  </div>
                </div>
              </div>
          ...
          <div class="btn-con">
            <el-button style="" class="next-btn" plain type="" @click="back">上一步</el-button>
            <el-button class="next-btn submit-btn" plain type="" @click="submitInfo">提交</el-button>
          </div>
        </template>
      </steps>
...
<script>
import {defineComponent, onBeforeMount, reactive, ref, unref} from 'vue'
import steps from '_com/my-steps/index.vue'
import Footer from '_com/footer/index.vue'
import {addeRelicsImg, addRelics, getDictType,} from "@/api/remain";
...
export default defineComponent({
  ...
  setup() {
    ...
    const next = () => {
      ...
      if(!form.value.administrativeDistrict){
        ElMessage.error('行政区属不能为空');
        return
      }
      if(!form.value.position){
        ElMessage.error('地理位置不能为空');
        return
      }
      if(!form.value.trafficCondition){
        ElMessage.error('交通状况不能为空');
        return
      }
      ...
      if(!form.value.description){
        ElMessage.error('地质遗迹景观描述与特征参数不能为空');
        return
      }
      if(!form.value.cause){
        ElMessage.error('成因分析不能为空');
        return
      }
      if(!form.value.otherLandscape){
        ElMessage.error('其它景观不能为空');
        return
      }
      if(!form.value.currentSituation){
        ElMessage.error('环境与保护现状不能为空');
        return
      }
      if(!form.value.developmentSituation){
        ElMessage.error('开发现状不能为空');
        return
      }
      if(!form.value.protection){
        ElMessage.error('保护措施不能为空');
        return
      }
      if(!form.value.level){
    ...
    const rules = reactive({
      // number: [
      //   { required: true, message: '请输入遗迹编号', trigger: 'blur' },
      // ],
    })
    ...
    //删除文件
    const delImgUpload = (id) => {
      deleteByUid(id, filelist.value)
    ...
    const submitInfo = async ()=>{
      ...
      if(!filelist.value.length){
        ...
        params.fileList = []
        let data = await addRelics(params)
        if(data.code == 0){
      ...
      let params = Object.assign({}, form.value);
      params.fileList = []
      let res = await addeRelicsImg(formData)
      if(res.code == 0) {
        params.fileList = res.data;
        let result = await addRelics(params)
        if(result.code == 0){
          // next()
          ElMessage.success('提交成功');
          hasSubmit.value = false;
