          ...
          <div class="form">
            <div class="scrollbar">
              <el-form :model="form" label-width="140px" label-position="left">
                <div class="item-con">
                  <el-row>
                    ...
                    <el-col :span="14" class="col_center">
                      <el-form-item label="名称" label-width="109px" class="mandatoryCon">
                ...
                <div class="item-con">
                  <el-row>
                    ...
                    <el-col :span="6" class="col_center">
                      <el-form-item label="北纬" label-width="110px" class="mandatoryCon">
                        <el-input v-model="form.latitude"></el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="5">
                      <el-form-item label="海拔" label-width="80px" class="mandatoryCon">
                        <el-input v-model="form.elevation"></el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="6">
                      <el-form-item label="面积" label-width="80px" class="mandatoryCon">
                ...
                <el-form-item label="地质遗迹景观描述与特征参数" class="mandatory">
            ...
            <div class="img-list">
              <div class="con">
                <div class="list" v-for="item in imgs" :key="item.id">
                  ...
                  <div class="img_del">
                    <img src="imgs/del_white.png" @click="delImgUpload(item.id,item.type)" alt="">
                  </div>
                </div>
              </div>
